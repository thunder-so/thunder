...
export class HostingConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: StaticProps) {
    ...
    this.cloudFrontRedirectsRewrites =
      this.createCloudFrontRedirectsRewrites(props);
  ...
  private createHostingBucket(props: StaticProps): Bucket {
    ...
    this.originAccessControl = new CfnOriginAccessControl(
      this,
      "CloudFrontOac",
      {
  ...
  private createCloudFrontRedirectsRewrites(
    props: StaticProps,
    ...
    const cloudFrontRedirectsRewrites = new experimental.EdgeFunction(
      this,
   ...
   *
   */
  private createCloudFrontHeaders(
    props: StaticProps,
  ): experimental.EdgeFunction {
    ...
    const cloudFrontHeadersFunction = new experimental.EdgeFunction(
      this,
      "HeadersFunction",
      {
        code: Code.fromInline(functionCode),
          ...
          ? [
              {
                ...
                functionVersion:
                  this.cloudFrontRedirectsRewrites.currentVersion,
              },
            ]
          : []),
  ...
  private findHostedZone(props: StaticProps): IHostedZone | void {
    ...
    return HostedZone.fromHostedZoneAttributes(
      this,
      `${this.resourceIdPrefix}-hosted-zone`,
      {
